  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator initialRouteName="2. Criação de Interface">
        ...
        <Drawer.Screen
          name="2.1.3 Gerenciadores"
          component={GerenciadorLayout}
        />
        <Drawer.Screen name="2.1.4 Componentes" component={ComponentesTela} />
        <Drawer.Screen name="2.1.6 Diálogos" component={DialogoModal} />
        <Drawer.Screen name="2.1.7 Barra de Ação" component={BarraDeAcao} />
        <Drawer.Screen
          name="2.2 Controle de Elementos"
          component={ControleElementos}
        />
        <Drawer.Screen
          name="2.2.1 Tratamento de Exceções"
          component={TratamentoExcecoes}
        />
        <Drawer.Screen
          name="2.2.2 Manipulação Listas"
